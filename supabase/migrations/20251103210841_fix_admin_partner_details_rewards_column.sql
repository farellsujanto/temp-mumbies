/*
  # Fix Admin Partner Details - Use Correct Rewards Column

  1. Changes
    - Use nonprofit_id for partner_rewards join (not partner_id)
*/
...
BEGIN
  ...
  LEFT JOIN partner_rewards pr ON n.id = pr.nonprofit_id
  WHERE n.id = p_partner_id;
