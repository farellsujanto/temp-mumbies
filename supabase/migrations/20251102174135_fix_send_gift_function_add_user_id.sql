/*
  # Fix send_gift_to_lead_secure Function - Add user_id

  1. Changes
    - Add auth_user_id lookup from nonprofits table
    - Include balance_type in partner_transactions insert
    - Properly populate all required fields
...
BEGIN
  ...
  -- Record detailed transaction with user_id and balance_type
