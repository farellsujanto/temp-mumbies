/*
  # Create Admin Partner Details Function

  1. Changes
    - Creates function to get comprehensive partner details for admin
    - Returns partner info, balance, statistics, and transaction history
    - Used by admin partner detail page

  2. Security
    - Function is SECURITY DEFINER to bypass RLS
    - Only accessible via service role or admin users
*/
