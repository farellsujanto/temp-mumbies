/*
  ...
  ## Important Notes
  - Uses existing field names: total_value, featured_image_url, unlock_requirement_value
  - is_universal defaults to true (available to all partners)
  - allow_reuse defaults to false (one-time use)
  - is_active defaults to true (visible to partners)
*/
...
-- Grant admin access to manage bundles
-- Note: Existing RLS policies should already handle this
